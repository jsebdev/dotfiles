...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
        ...
        basedpyright = {
          before_init = function(_, config)
            config.settings.python = vim.tbl_deep_extend('force', config.settings.python or {}, {
              pythonPath = require('custom.utils.get_python_path').get_python_path(),
            })
          end,
          settings = {
            basedpyright = {
      ...
      for server_name, server_configuration in pairs(servers) do
...
require 'custom.autocmds.large_files'
